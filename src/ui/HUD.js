...
export default class HUD {
  constructor(scene) {
    ...
    this.lionIcon = scene.add.sprite(28, 22, 'lion_run', 0)
      .setScale(0.7).setDepth(201);
    ...
    // Multiplier badge (right of score)
    ...
    // Distance (top-right)
    this.distanceText = scene.add.text(GAME_WIDTH - 12, 10, '0 m', {
  ...
  update(lionCount, distance, speed, score, multiplier) {
    ...
    if (multiplier > 1) {
      this.multText.setText(`x${multiplier}`);
    } else {
